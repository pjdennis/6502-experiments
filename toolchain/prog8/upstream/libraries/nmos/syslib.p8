; Prog8 syslib for the '6502-experiments' emulator (nmos machine).
; Adapted from the upstream Neo6502 custom-target example. I/O is via the
; emulator's $F006+ syscall stubs; exit via $F00F.
...
p8_sys_startup {
    ...
    asmsub  cleanup_at_exit() {
        ...
        %asm {{
            lda  _exitcode
            jmp  $f00f          ; emulator exit stub (code in A)
