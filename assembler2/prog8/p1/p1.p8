...
sub emit_mangled(uword identid) {
    out_byte($70) out_byte($38) out_byte($76) out_byte($5f)
    out_ident_text(identid)
}

; shared instruction-prefix fragments (leading 2-space indent included)
sub o_nl()  { out_byte($0a) }
sub o_lda() { out_byte($20) out_byte($20) out_byte($6c) out_byte($64) out_byte($61) out_byte($20) }
sub o_ldy() { out_byte($20) out_byte($20) out_byte($6c) out_byte($64) out_byte($79) out_byte($20) }
sub o_sta() { out_byte($20) out_byte($20) out_byte($73) out_byte($74) out_byte($61) out_byte($20) }
sub o_sty() { out_byte($20) out_byte($20) out_byte($73) out_byte($74) out_byte($79) out_byte($20) }
sub o_imm() { out_byte($23) out_byte($24) }      ; "#$"
sub o_plus1() { out_byte($2b) out_byte($31) }    ; "+1"
...
sub emit_zp_bindings() {
    ...
    out_byte($0a)
    out_byte($3b) out_byte($20) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($20) out_byte($5a) out_byte($50) out_byte($20) out_byte($76) out_byte($61)
    out_byte($72) out_byte($69) out_byte($61) out_byte($62) out_byte($6c) out_byte($65) out_byte($20) out_byte($61) out_byte($6c) out_byte($6c) out_byte($6f) out_byte($63)
    out_byte($61) out_byte($74) out_byte($69) out_byte($6f) out_byte($6e) out_byte($73) out_byte($20) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($0a)
    uword i
    i = 0
    repeat {
        if i >= sym_count {
    ...
    out_byte($20) out_byte($3d) out_byte($20) out_byte($24)
...
sub codegen_assign(uword st) {
    ...
    emit_lda_sym(si)
    if op == TK_PLUSEQ {
    out_byte($20) out_byte($20) out_byte($63) out_byte($6c) out_byte($63)
        o_nl()
    out_byte($20) out_byte($20) out_byte($61) out_byte($64) out_byte($63) out_byte($20)
        emit_binop_operand(rhs)
        o_nl()
    }
    if op == TK_MINUSEQ {
    out_byte($20) out_byte($20) out_byte($73) out_byte($65) out_byte($63)
        o_nl()
    out_byte($20) out_byte($20) out_byte($73) out_byte($62) out_byte($63) out_byte($20)
        emit_binop_operand(rhs)
        o_nl()
    }
    if op == TK_ANDEQ {
    out_byte($20) out_byte($20) out_byte($61) out_byte($6e) out_byte($64) out_byte($20)
        emit_binop_operand(rhs)
        o_nl()
    }
    if op == TK_OREQ {
    out_byte($20) out_byte($20) out_byte($6f) out_byte($72) out_byte($61) out_byte($20)
        emit_binop_operand(rhs)
        o_nl()
    }
    if op == TK_XOREQ {
    out_byte($20) out_byte($20) out_byte($65) out_byte($6f) out_byte($72) out_byte($20)
        emit_binop_operand(rhs)
        o_nl()
    }
    emit_sta_sym(si)
