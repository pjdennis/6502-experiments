...
; byte-identical to `python3 -m p8c source.p8 -o` (the oracle). It
; reuses stmt.p8's streaming front-end (lexer + shunting-yard expression
; parser + frame-stack statement driver + node arena) and replaces the
; AST serializer with a codegen back-end (port of p8c/codegen.py).
;
; Milestone P7-M1: `main { }` (nmos) -> prologue + ZP scratch bindings +
; empty p8s_main + the nmos exit epilogue + reset vector. See
; ../PHASE7_DESIGN.md for the full plan (passes S / M / B, the symbol
; table, and milestones P7-M1..M6).
...
; ---- codegen: fixed assembly text (byte-identical to p8c/codegen.py) ----
; p8c offers no string-literal-as-data, so each fixed block is spelled out
; byte by byte via out_byte() runs -- the same idiom the parser's serializer
; used. The only variable in the prologue is the .org address.

sub emit_prologue() {
    out_byte($3b) out_byte($20) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($20) out_byte($67) out_byte($65) out_byte($6e) out_byte($65) out_byte($72)
    out_byte($61) out_byte($74) out_byte($65) out_byte($64) out_byte($20) out_byte($62) out_byte($79) out_byte($20) out_byte($70) out_byte($38) out_byte($63) out_byte($20)
    out_byte($2d) out_byte($2d) out_byte($20) out_byte($44) out_byte($4f) out_byte($20) out_byte($4e) out_byte($4f) out_byte($54) out_byte($20) out_byte($45) out_byte($44)
    out_byte($49) out_byte($54) out_byte($20) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($0a) out_byte($3b) out_byte($20) out_byte($73) out_byte($6f)
    out_byte($75) out_byte($72) out_byte($63) out_byte($65) out_byte($3a) out_byte($20) out_byte($53) out_byte($52) out_byte($43) out_byte($0a) out_byte($3b) out_byte($20)
    out_byte($74) out_byte($61) out_byte($72) out_byte($67) out_byte($65) out_byte($74) out_byte($3a) out_byte($20) out_byte($6e) out_byte($6d) out_byte($6f) out_byte($73)
    out_byte($20) out_byte($28) out_byte($76) out_byte($61) out_byte($73) out_byte($6d) out_byte($20) out_byte($62) out_byte($75) out_byte($69) out_byte($6c) out_byte($64)
    out_byte($73) out_byte($20) out_byte($61) out_byte($20) out_byte($73) out_byte($65) out_byte($6c) out_byte($66) out_byte($2d) out_byte($63) out_byte($6f) out_byte($6e)
    out_byte($74) out_byte($61) out_byte($69) out_byte($6e) out_byte($65) out_byte($64) out_byte($20) out_byte($36) out_byte($35) out_byte($30) out_byte($32) out_byte($20)
    out_byte($62) out_byte($69) out_byte($6e) out_byte($61) out_byte($72) out_byte($79) out_byte($2c) out_byte($20) out_byte($72) out_byte($65) out_byte($73) out_byte($65)
    out_byte($74) out_byte($20) out_byte($76) out_byte($65) out_byte($63) out_byte($74) out_byte($6f) out_byte($72) out_byte($0a) out_byte($3b) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($61) out_byte($74) out_byte($20) out_byte($24) out_byte($46) out_byte($46) out_byte($46) out_byte($43) out_byte($20) out_byte($70) out_byte($6f)
    out_byte($69) out_byte($6e) out_byte($74) out_byte($73) out_byte($20) out_byte($74) out_byte($6f) out_byte($20) out_byte($70) out_byte($38) out_byte($73) out_byte($5f)
    out_byte($6d) out_byte($61) out_byte($69) out_byte($6e) out_byte($3b) out_byte($20) out_byte($69) out_byte($6e) out_byte($74) out_byte($65) out_byte($6e) out_byte($64)
    out_byte($65) out_byte($64) out_byte($20) out_byte($66) out_byte($6f) out_byte($72) out_byte($20) out_byte($74) out_byte($68) out_byte($65) out_byte($20) out_byte($65)
    out_byte($6d) out_byte($75) out_byte($6c) out_byte($61) out_byte($74) out_byte($6f) out_byte($72) out_byte($27) out_byte($73) out_byte($0a) out_byte($3b) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($6e) out_byte($6d) out_byte($6f) out_byte($73) out_byte($2d) out_byte($64) out_byte($65) out_byte($66) out_byte($61) out_byte($75)
    out_byte($6c) out_byte($74) out_byte($20) out_byte($6d) out_byte($61) out_byte($63) out_byte($68) out_byte($69) out_byte($6e) out_byte($65) out_byte($20) out_byte($77)
    out_byte($69) out_byte($74) out_byte($68) out_byte($20) out_byte($66) out_byte($69) out_byte($6c) out_byte($65) out_byte($2d) out_byte($49) out_byte($2f) out_byte($4f)
    out_byte($20) out_byte($73) out_byte($74) out_byte($75) out_byte($62) out_byte($73) out_byte($20) out_byte($61) out_byte($74) out_byte($20) out_byte($24) out_byte($46)
    out_byte($30) out_byte($30) out_byte($36) out_byte($2d) out_byte($24) out_byte($46) out_byte($30) out_byte($33) out_byte($43) out_byte($29) out_byte($2e) out_byte($0a)
    out_byte($0a) out_byte($5f) out_byte($5f) out_byte($70) out_byte($38) out_byte($63) out_byte($5f) out_byte($74) out_byte($6d) out_byte($70) out_byte($30) out_byte($20)
    out_byte($3d) out_byte($20) out_byte($24) out_byte($32) out_byte($30) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($3b) out_byte($20) out_byte($63) out_byte($6f) out_byte($64) out_byte($65) out_byte($67) out_byte($65) out_byte($6e) out_byte($20)
    out_byte($73) out_byte($63) out_byte($72) out_byte($61) out_byte($74) out_byte($63) out_byte($68) out_byte($20) out_byte($28) out_byte($62) out_byte($79) out_byte($74)
    out_byte($65) out_byte($29) out_byte($0a) out_byte($5f) out_byte($5f) out_byte($70) out_byte($38) out_byte($63) out_byte($5f) out_byte($74) out_byte($6d) out_byte($70)
    out_byte($31) out_byte($20) out_byte($3d) out_byte($20) out_byte($24) out_byte($32) out_byte($31) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($3b) out_byte($20) out_byte($63) out_byte($6f) out_byte($64) out_byte($65) out_byte($67) out_byte($65)
    out_byte($6e) out_byte($20) out_byte($73) out_byte($63) out_byte($72) out_byte($61) out_byte($74) out_byte($63) out_byte($68) out_byte($20) out_byte($28) out_byte($62)
    out_byte($79) out_byte($74) out_byte($65) out_byte($29) out_byte($0a) out_byte($5f) out_byte($5f) out_byte($70) out_byte($38) out_byte($63) out_byte($5f) out_byte($77)
    out_byte($74) out_byte($6d) out_byte($70) out_byte($30) out_byte($20) out_byte($3d) out_byte($20) out_byte($24) out_byte($32) out_byte($32) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($3b) out_byte($20) out_byte($63) out_byte($6f) out_byte($64) out_byte($65) out_byte($67)
    out_byte($65) out_byte($6e) out_byte($20) out_byte($73) out_byte($63) out_byte($72) out_byte($61) out_byte($74) out_byte($63) out_byte($68) out_byte($20) out_byte($28)
    out_byte($77) out_byte($6f) out_byte($72) out_byte($64) out_byte($29) out_byte($0a) out_byte($5f) out_byte($5f) out_byte($70) out_byte($38) out_byte($63) out_byte($5f)
    out_byte($77) out_byte($74) out_byte($6d) out_byte($70) out_byte($31) out_byte($20) out_byte($3d) out_byte($20) out_byte($24) out_byte($32) out_byte($34) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($3b) out_byte($20) out_byte($63) out_byte($6f) out_byte($64) out_byte($65)
    out_byte($67) out_byte($65) out_byte($6e) out_byte($20) out_byte($73) out_byte($63) out_byte($72) out_byte($61) out_byte($74) out_byte($63) out_byte($68) out_byte($20)
    out_byte($28) out_byte($77) out_byte($6f) out_byte($72) out_byte($64) out_byte($29) out_byte($0a) out_byte($5f) out_byte($5f) out_byte($70) out_byte($38) out_byte($63)
    out_byte($5f) out_byte($70) out_byte($74) out_byte($72) out_byte($30) out_byte($20) out_byte($20) out_byte($3d) out_byte($20) out_byte($24) out_byte($32) out_byte($36)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($3b) out_byte($20) out_byte($69) out_byte($6e)
    out_byte($64) out_byte($69) out_byte($72) out_byte($65) out_byte($63) out_byte($74) out_byte($2d) out_byte($59) out_byte($20) out_byte($70) out_byte($6f) out_byte($69)
    out_byte($6e) out_byte($74) out_byte($65) out_byte($72) out_byte($20) out_byte($28) out_byte($32) out_byte($20) out_byte($62) out_byte($79) out_byte($74) out_byte($65)
    out_byte($73) out_byte($29) out_byte($0a) out_byte($5f) out_byte($5f) out_byte($70) out_byte($38) out_byte($63) out_byte($5f) out_byte($61) out_byte($70) out_byte($74)
    out_byte($72) out_byte($20) out_byte($20) out_byte($3d) out_byte($20) out_byte($24) out_byte($32) out_byte($38) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($20)
    out_byte($20) out_byte($20) out_byte($20) out_byte($20) out_byte($3b) out_byte($20) out_byte($61) out_byte($72) out_byte($72) out_byte($61) out_byte($79) out_byte($20)
    out_byte($65) out_byte($6c) out_byte($65) out_byte($6d) out_byte($65) out_byte($6e) out_byte($74) out_byte($20) out_byte($70) out_byte($6f) out_byte($69) out_byte($6e)
    out_byte($74) out_byte($65) out_byte($72) out_byte($20) out_byte($28) out_byte($32) out_byte($20) out_byte($62) out_byte($79) out_byte($74) out_byte($65) out_byte($73)
    out_byte($29) out_byte($0a) out_byte($0a) out_byte($20) out_byte($20) out_byte($2e) out_byte($6f) out_byte($72) out_byte($67) out_byte($20) out_byte($24)
    out_hex4(prog_address)
    out_byte($0a) out_byte($20) out_byte($20) out_byte($6a) out_byte($6d) out_byte($70) out_byte($20) out_byte($70) out_byte($38) out_byte($73) out_byte($5f) out_byte($6d)
    out_byte($61) out_byte($69) out_byte($6e) out_byte($0a)
}

; emit `main`: the `; ---- sub main ----` header, the body, then the
; per-sub return label + nmos exit epilogue. (M1: the body is empty.)
sub emit_main(uword body) {
    out_byte($0a) out_byte($0a) out_byte($3b) out_byte($20) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($20) out_byte($73) out_byte($75) out_byte($62)
    out_byte($20) out_byte($6d) out_byte($61) out_byte($69) out_byte($6e) out_byte($20) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($0a) out_byte($70)
    out_byte($38) out_byte($73) out_byte($5f) out_byte($6d) out_byte($61) out_byte($69) out_byte($6e) out_byte($3a) out_byte($0a)
    codegen_block(body)
    out_byte($2e) out_byte($4c) out_byte($70) out_byte($38) out_byte($73) out_byte($5f) out_byte($6d) out_byte($61) out_byte($69) out_byte($6e) out_byte($5f) out_byte($72)
    out_byte($65) out_byte($74) out_byte($3a) out_byte($0a) out_byte($20) out_byte($20) out_byte($6c) out_byte($64) out_byte($61) out_byte($20) out_byte($23) out_byte($24)
    out_byte($30) out_byte($30) out_byte($0a) out_byte($20) out_byte($20) out_byte($6a) out_byte($73) out_byte($72) out_byte($20) out_byte($24) out_byte($66) out_byte($30)
    out_byte($30) out_byte($66) out_byte($0a) out_byte($20) out_byte($20) out_byte($62) out_byte($72) out_byte($6b) out_byte($0a)
}

; emit the nmos trailers: reset vector at $FFFC. (M2+ inserts arrays /
; memvars / the string pool ahead of this.)
sub emit_trailers() {
    out_byte($0a) out_byte($20) out_byte($20) out_byte($3b) out_byte($20) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($2d) out_byte($20) out_byte($72) out_byte($65)
    out_byte($73) out_byte($65) out_byte($74) out_byte($20) out_byte($76) out_byte($65) out_byte($63) out_byte($74) out_byte($6f) out_byte($72) out_byte($20) out_byte($2d)
    out_byte($2d) out_byte($2d) out_byte($2d) out_byte($0a) out_byte($20) out_byte($20) out_byte($2e) out_byte($6f) out_byte($72) out_byte($67) out_byte($20) out_byte($24)
    out_byte($46) out_byte($46) out_byte($46) out_byte($43) out_byte($0a) out_byte($20) out_byte($20) out_byte($2e) out_byte($77) out_byte($6f) out_byte($72) out_byte($64)
    out_byte($20) out_byte($70) out_byte($38) out_byte($73) out_byte($5f) out_byte($6d) out_byte($61) out_byte($69) out_byte($6e) out_byte($0a) out_byte($20) out_byte($20)
    out_byte($2e) out_byte($77) out_byte($6f) out_byte($72) out_byte($64) out_byte($20) out_byte($24) out_byte($30) out_byte($30) out_byte($30) out_byte($30) out_byte($0a)
    out_byte($0a)
}

; codegen a block's statements in source order. The block node's `a` field
; is a reversed cons head; reverse it, then emit each statement.
...
; codegen a single statement. (M1: no statement kinds yet -- empty main.)
sub codegen_stmt(uword st) {
    ; placeholder -- statement codegen arrives at P7-M2.
    st = st
}
...
; Pass A parses directives + module decls (target / address). Then we emit
; the prologue, run pass M (find + codegen `main`), and emit the trailers.
; (Pass S -- whole-program symbol table -- and pass B -- other subs -- are
; introduced at P7-M2 / later; M1 has neither vars nor non-main subs.)
main {
    uword fn
    fn = _argv(0)
    src_hand = _open(fn)
