...
* **Test counts (as of HEAD)**:
  ...
  * **174 total, all green** (the 22 tinyp8 + 47 p1 cases need vasm; see the
    ...
    break/continue + repeat + for + when; P7-M5 void subs + calls + return values + params + locals; builtins lsb/msb/peek/poke/mkword).
