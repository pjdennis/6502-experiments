; Prog8 syslib for the '6502-experiments' emulator (wendy2c machine, banked).
; Adapted from the nmos custom-target syslib. The wendy2c machine has no
; $F00F exit syscall (that's the nmos machine): "exit" halts the CPU with
; STP and the emulator dumps the LCD frame. Output is the HD44780 LCD (see
; textio.p8). Banking helpers live in banking.p8.
