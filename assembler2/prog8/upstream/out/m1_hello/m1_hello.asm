; w65c02 assembly code for 'm1_hello'
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2026-06-06T18:59:55
...
; ---- block: 'p8b_main' ----
p8b_main	.proc
	; source: demos/m1_hello.p8:4   main {


	; source: demos/m1_hello.p8:5   sub start() {

p8s_start	.proc
	jsr  prog8_lib.program_startup_clear_bss
+
; statements
	; source: demos/m1_hello.p8:6   txt.clear()
	jsr  txt.clear
	; source: demos/m1_hello.p8:7   txt.print("hello wendy2")
	ldy  #>prog8_interned_strings.string_1
	lda  #<prog8_interned_strings.string_1
	jsr  txt.print
	; source: demos/m1_hello.p8:8   txt.line2()
	jsr  txt.line2
	; source: demos/m1_hello.p8:9   txt.print("bank target ok")
...
string_1	; CP437:"hello wendy2"
	.byte  $68, $65, $6c, $6c, $6f, $20, $77, $65, $6e, $64, $79, $32, $00
string_2	; CP437:"bank target ok"
	.byte  $62, $61, $6e, $6b, $20, $74, $61, $72, $67, $65, $74, $20, $6f, $6b, $00
