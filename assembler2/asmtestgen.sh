...
make --quiet
./asm0c.out 00/asm00.asm out/asm00.out
./emulator.out out/asm00.out 2000 01/asm01.asm out/asm01.out
./emulator.out out/asm01.out 2000 02/asm02.asm out/asm02.out
./emulator.out out/asm02.out 2000 03/asm03.asm out/asm03.out
./emulator.out out/asm03.out 2000 04/asm04.asm out/asm04.out
./emulator.out out/asm04.out 2000 05/asm05.asm out/asm05.out
./emulator.out out/asm05.out 2000 06/asm06.asm out/asm06.out
./emulator.out out/asm06.out 2000 07/instgen07.asm out/instgen07.out
...
cat out/inst07.asm.out 08/asm08.asm > out/asm08c.asm.out
./emulator.out out/asm07c.out 2000 out/asm08c.asm.out out/asm08c.out
cat out/inst07.asm.out 09/asm09.asm > out/asm09c.asm.out
./emulator.out out/asm08c.out 2000 out/asm09c.asm.out out/asm09c.out
cat out/inst07.asm.out 10/asm10.asm > out/asm10c.asm.out
...
(cd 13 && ../emulator.out ../out/asm12.out 2000 /dev/null /dev/null asm13.asm ../out/asm13.out)
(cd 14 && ../emulator.out ../out/asm13.out 2000 /dev/null /dev/null instgen14.asm ../out/instgen14.out)
./emulator.out out/instgen14.out 2000 /dev/null out/inst14.asm.out
(cd 14 && ../emulator.out ../out/asm13.out 2000 /dev/null /dev/null asm14.asm ../out/asm14.out)
(cd 15 && ../emulator.out ../out/asm14.out 2000 /dev/null /dev/null instgen15.asm ../out/instgen15.out)
./emulator.out out/instgen15.out 2000 /dev/null out/inst15.asm.out
(cd 15 && ../emulator.out ../out/asm14.out 2000 /dev/null /dev/null asm15.asm ../out/asm15.out)
(cd 16 && ../emulator.out ../out/asm15.out 2000 /dev/null /dev/null instgen16.asm ../out/instgen16.out)
...
(cd 18 && ../emulator.out ../out/asm17.out 2000 /dev/null /dev/null instgen18.asm ../out/instgen18.out)
./emulator.out out/instgen18.out 2000 /dev/null out/inst18.asm.out
diff out/inst16.asm.out out/inst18.asm.out
(cd 18 && ../emulator.out ../out/asm17.out 2000 /dev/null /dev/null asm18.asm ../out/asm18.out)
(cd 19 && ../emulator.out ../out/asm18.out 2000 /dev/null /dev/null instgen19.asm ../out/instgen19.out)
./emulator.out out/instgen19.out 2000 /dev/null out/inst19.asm.out
(cd 19 && ../emulator.out ../out/asm18.out 2000 /dev/null /dev/null asm19.asm ../out/asm19.out)
(cd 20 && ../emulator.out ../out/asm19.out 2000 /dev/null /dev/null instgen20.asm ../out/instgen20.out)
./emulator.out out/instgen20.out 2000 /dev/null out/inst20.asm.out
(cd 20 && ../emulator.out ../out/asm19.out 2000 /dev/null /dev/null asm20.asm ../out/asm20.out)
(cd 21 && ../emulator.out ../out/asm20.out 2000 /dev/null /dev/null instgen21.asm ../out/instgen21.out)
./emulator.out out/instgen21.out 2000 /dev/null out/inst21.asm.out
(cd 21 && ../emulator.out ../out/asm20.out 2000 /dev/null /dev/null asm21.asm ../out/asm21.out)
(cd 21 && ../emulator.out ../out/asm20.out 2000 /dev/null /dev/null asm21.asm ../out/asm21_debug.out define:enable_debug)
./emulator.out out/asm21_debug.out 2000 /dev/null /dev/null tests/file_stack_test22.asm out/file_stack_test22.out
(cd 22 && ../emulator.out ../out/asm21_debug.out 2000 /dev/null /dev/null instgen22.asm ../out/instgen22.out)
./emulator.out out/instgen22.out 2000 /dev/null out/inst22.asm.out
(cd 22 && ../emulator.out ../out/asm21_debug.out 2000 /dev/null /dev/null asm22.asm ../out/asm22.out)
(cd 22 && ../emulator.out ../out/asm21_debug.out 2000 /dev/null /dev/null asm22.asm ../out/asm22_debug.out define:enable_debug)
