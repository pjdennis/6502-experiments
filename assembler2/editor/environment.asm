; Environment definitions for programs using the emulator
; Includes both standard I/O and console mode ports

; Standard I/O ports (from 22/environment.asm)
...
openout   = $F021 ; Opens file with name at A;X for writing. Returns handle
                  ; in A; Y preserved
write     = $F024 ; Writes char in A to file with handle in X; Y preserved
